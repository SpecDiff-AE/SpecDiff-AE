...
class Qwen2FlashAttention2(Qwen2Attention):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Keep the RoCm compatibility branch until flash-attn behavior is uniform.
...
class Qwen2SdpaAttention(Qwen2Attention):
    ...
    def forward(
        ...
        if output_attentions:
            # Keep upstream warning behavior for non-eager attention.
            logger.warning_once(
...
class Qwen2ForCausalLM(Qwen2PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        # Keep upstream logits casting behavior for this adapter.
